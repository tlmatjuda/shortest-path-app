...
# ================================================================================================================
info "restart-app.sh" "Restarting database : ${SPA_DOCKER_CONTAINER_NAME_APPLICATION}"

${SPA_RESTART_DATABASE_SCRIPT_PATH}/stop-app.sh && \
${SPA_RESTART_DATABASE_SCRIPT_PATH}/start-app.sh

info "restart-app.sh" "${SPA_DOCKER_CONTAINER_NAME_APPLICATION} : container restarted!"
